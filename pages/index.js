          ...
          <div className="mt-8">
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                {/* Paragraf 1 (kanan) */}
                <div className="text-slate-700 dark:text-slate-200 leading-relaxed text-justify tracking-wid">
                  <p>
              ...
              {/* Baris 2: Paragraf 2 full width */}
              <div className="mt-6 text-slate-700 dark:text-slate-200 leading-relaxed text-justify tracking-wid">
                <p>
