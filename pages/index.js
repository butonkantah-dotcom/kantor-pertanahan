...
} revisi sedikit codenya seperti bagian header brand agar di perbesar sedikit, kata "Anda" di buat sejajar dengan kata "Cek Status & Kelengkapan Berkas", salin bagikan cetak dihapus saja, hilangkan icon tanda tanya, poin nomor 4 di pertanyaan yang sering diajukan di hapus, dibagian dokumen yang tidak lengkap dibuat list nomor kalau dokumen yang kurang lebih dari satu seperti di spreedsheet, proses mencari  data buatkan icon loading saja di tengah tanpa ada tulisan mencari data
